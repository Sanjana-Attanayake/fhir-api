...
final r5:ResourceAPIConfig  operationdefinitionApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[OperationDefinition](operationdefinition.html): External identifier for the search parameter",
            builtin: false,
