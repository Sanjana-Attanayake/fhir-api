...
final r5:ResourceAPIConfig  immunizationevaluationApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[ImmunizationEvaluation](immunizationevaluation.html): ID of the evaluation",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[ImmunizationEvaluation](immunizationevaluation.html): Date the evaluation was generated",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[ImmunizationEvaluation](immunizationevaluation.html): The patient being evaluated",
            builtin: false,
