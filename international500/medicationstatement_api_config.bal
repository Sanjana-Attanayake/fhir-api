...
final r5:ResourceAPIConfig  medicationstatementApiConfig = {
    ...
    searchParameters: [
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/MedicationStatement-adherence"
        }
    },
        ...
        active: true,
        information: {
            description: "[MedicationStatement](medicationstatement.html): Returns statements for a specific encounter",
            builtin: false,
