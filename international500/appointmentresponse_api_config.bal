...
final r5:ResourceAPIConfig  appointmentresponseApiConfig = {
    ...
    searchParameters: [
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/AppointmentResponse-group"
        }
    },
        ...
        active: true,
        information: {
            description: "[AppointmentResponse](appointmentresponse.html): An Identifier in this appointment response",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[AppointmentResponse](appointmentresponse.html): This Response is for this Patient",
            builtin: false,
