...
final r5:ResourceAPIConfig  procedureApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[Procedure](procedure.html): When the procedure occurred or is occurring",
            builtin: false,
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/Procedure-report"
        }
    },
        ...
        active: true,
        information: {
            description: "[Procedure](procedure.html): The Encounter during which this Procedure was created",
            builtin: false,
