...
final r5:ResourceAPIConfig  communicationrequestApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[CommunicationRequest](communicationrequest.html): Unique identifier",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[CommunicationRequest](communicationrequest.html): Focus of message",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[CommunicationRequest](communicationrequest.html): The Encounter during which this CommunicationRequest was created",
            builtin: false,
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/CommunicationRequest-information-provider"
        }
    },
