...
final r5:ResourceAPIConfig  medicationApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[Medication](medication.html): Returns medications with this external identifier",
            builtin: false,
        ...
        information: {
            description: "Returns medications in a batch with this lot number",
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/Medication-serial-number"
        }
    },
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/Medication-marketingauthorizationholder"
        }
    }
