...
final r5:ResourceAPIConfig  medicationadministrationApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[MedicationAdministration](medicationadministration.html): Date administration happened (or did not happen)",
            builtin: false,
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/MedicationAdministration-reason-given-code"
        }
    },
        ...
        active: true,
        information: {
            description: "[MedicationAdministration](medicationadministration.html): Return administrations of this medication reference",
            builtin: false,
        ...
        information: {
            description: "The identity of the individual who administered the medication",
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/MedicationAdministration-performer-device-code"
        }
    },
        ...
        active: true,
        information: {
            description: "[MedicationAdministration](medicationadministration.html): Return administrations that share this encounter",
            builtin: false,
