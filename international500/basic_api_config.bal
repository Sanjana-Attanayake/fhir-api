...
final r5:ResourceAPIConfig  basicApiConfig = {
    resourceType: "Basic",
    profiles: [
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[Basic](basic.html): Kind of Resource",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[Basic](basic.html): Business identifier",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[Basic](basic.html): Identifies the focus of this resource",
            builtin: false,
