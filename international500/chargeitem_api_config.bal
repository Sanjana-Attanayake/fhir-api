...
final r5:ResourceAPIConfig  chargeitemApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[ChargeItem](chargeitem.html): A code that identifies the charge, like a billing code",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[ChargeItem](chargeitem.html): Business Identifier for item",
            builtin: false,
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/ChargeItem-status"
        }
    },
        ...
        active: true,
        information: {
            description: "[ChargeItem](chargeitem.html): Individual service was done for/to",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[ChargeItem](chargeitem.html): Encounter associated with event",
            builtin: false,
