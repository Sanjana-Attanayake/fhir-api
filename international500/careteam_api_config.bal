...
final r5:ResourceAPIConfig  careteamApiConfig = {
    ...
    searchParameters: [
        ...
        information: {
            ...
            builtin: false,
            documentation: "http://hl7.org/fhir/SearchParameter/CareTeam-name"
        }
    },
        ...
        active: true,
        information: {
            description: "[CareTeam](careteam.html): A date within the coverage time period.",
            builtin: false,
