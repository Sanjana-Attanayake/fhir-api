...
final r5:ResourceAPIConfig  implementationguideApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[ImplementationGuide](implementationguide.html): External identifier for the implementation guide",
            builtin: false,
