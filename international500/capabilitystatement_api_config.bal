...
final r5:ResourceAPIConfig  capabilitystatementApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[CapabilityStatement](capabilitystatement.html): External identifier for the capability statement",
            builtin: false,
