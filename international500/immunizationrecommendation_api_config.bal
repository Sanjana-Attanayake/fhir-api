...
final r5:ResourceAPIConfig  immunizationrecommendationApiConfig = {
    ...
    searchParameters: [
        ...
        active: true,
        information: {
            description: "[ImmunizationRecommendation](immunizationrecommendation.html): Business identifier",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[ImmunizationRecommendation](immunizationrecommendation.html): Date recommendation(s) created",
            builtin: false,
        ...
        active: true,
        information: {
            description: "[ImmunizationRecommendation](immunizationrecommendation.html): Who this profile is for",
            builtin: false,
